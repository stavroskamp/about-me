...
const experienceContent = [
  {
    ...
    jobDescription: (
      <React.Fragment>
        <Typography as="p">
          In Fieldscale I was working in a web application that tried to make the
          simulation of a capacitive touch sensor easier. There I was the main Front End
          Developer and my focus was in:
        </Typography>
        <ul>
          <Typography as="li">
...
const Experience = () => (
  <StyledExperienceWrapper id="experience">
    ...
    {experienceContent.map((t, index) => (<ExperienceBox
      key={index}
      company={t.company}
      jobTitle={t.jobTitle}
